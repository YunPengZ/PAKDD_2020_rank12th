...
def get_test_df(file_dir,use_feas):
    chunk_size = 1e6
    print(file_dir)
...
fault_tag_08 = pd.read_csv('../user_data/tmp_data/disk_sample_fault_tag_201808.csv')
...
del df_1807,df_1806,df_1805,df_1804,df_1803
...
#joblib.dump(clf, '../user_data/model_data/model.dat')#存储到文件位置
...
for i in range(30): # 30
    ...
    test_df = get_test_df(file_dir_test,raw_feas)
    ####向前取21天数据
